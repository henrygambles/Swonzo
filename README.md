...
This was made as a personal project, though should work with any Monzo account. It's worth mentioning that any & all data generated by Swonzo stays on your device - and there is also a Demo mode using exampe data which uses allows users to check out the app without signing in through their Monzo account.
