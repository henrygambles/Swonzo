...
//  Swonzo
//
//  Created by Henry Gambles on 16/07/2019.
...
//let swonzo = try? newJSONDecoder().decode(Swonzo.self, from: dataResponse.data)
//print("EEEEEEEEEEEEEEEAAAAAAAAAA SPORTTTTTTTTTYSSSSSSS")
//print(swonzo)
    ...
    func execute(_ url: URL, completion: @escaping WebServiceResponse) {
        ...
        Alamofire.request(url,
                          ...
                          headers: headers).responseSwiftyJSON { dataResponse in
                            ...
                            let swonzo = try? JSONDecoder().decode(Swonzo.self, from: dataResponse.data!)
